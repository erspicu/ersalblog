...
- [2026-02-09 01:40:00] 優化相簿詳情頁視覺層次：為照片資訊與技術資訊區塊加入卡片式框線與背景底色。
- [2026-02-09 01:45:00] 同步更新相簿所有佈景主題 (Dark, Pink, Matrix) 的 CSS 樣式，確保照片資訊與 EXIF 卡片在各風格下皆有適配的視覺呈現。
- [2026-02-09 01:50:00] 修正深色主題中相簿詳情頁背景過亮的問題，確保所有資訊容器皆套用正確的深色背景與邊框。
- [2026-02-09 02:00:00] 統一相簿詳情頁中照片資訊與 EXIF 卡片的視覺樣式，使其在所有主題下皆具備一致的底色與邊框設計。
- [2026-02-09 02:15:00] 執行 HTML 結構解耦：將 album.js 中所有硬編碼的 HTML 抽離至 album_template.html 的 <template> 標籤中，實現邏輯與表現層的徹底分離。
- [2026-02-09 02:40:00] 更新 ROADMAP.md 與 TODO.md 文件，將相簿整合、GPS 地圖、縮圖優化與設定重構等項目標記為已完成，並同步系統開發狀態。
